      ...
      <Head>
        ...
        <div className=" w-screen h-screen md:h- text-lg flex justify-center align-middle items-center">
          ...
          <div className="grid_fade absolute w-screen h-screen"></div>
            <div className="">
              <p className="text-sm font-mono uppercase">Welcome to the web portfolio of</p>
              <h1 className="mb-1 text-5xl font-extrabold leading-none tracking-tight text-gray-900 md:text-7xl lg:text-9xl dark:text-white">Ryan<br></br> <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#4CA5FF] to-[#B375F8]">Jacobson</span></h1>
