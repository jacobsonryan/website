...
export default function Projects() {
  ...
  return (
    <>
      ...
      <h2 className=" mt-20  text-5xl font-extrabold align-left text-center mb-10 select-none"><span className="text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-blue-600">Featured Projects</span></h2>
